...
{
	LearnWordsApp(): _additionalCheck(this, &wordsOnDisk), _mandatoryCheck(this, &wordsOnDisk), _learnNew(this, &wordsOnDisk), _repeatOfRecent(this, &wordsOnDisk), curTime(0) {}
